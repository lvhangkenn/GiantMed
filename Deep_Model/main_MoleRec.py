...
from util_MoleRec import buildPrjSmiles
from training_MoleRec import Test, Train
...
def parse_args():
    ...
    parser.add_argument(
        '--resume_path', type=str,default="ckpt_MoleRec.model",
    ...
    parser.add_argument(
        '--embedding', default=True, type=bool,
...
if __name__ == '__main__':
    ...
    data_path = '../data/ready/MIMIC-III/records_final.pkl'
    voc_path = '../data/ready/MIMIC-III/voc_final.pkl'
    ddi_adj_path = '../data/ready/MIMIC-III/ddi_A_final.pkl'
    ddi_mask_path = '../data/ready/MIMIC-III/ddi_mask_H.pkl'
    molecule_path = '../data/ready/MIMIC-III/idx2SMILES.pkl'
    substruct_smile_path = '../data/ready/MIMIC-III/substructure_smiles.pkl'
