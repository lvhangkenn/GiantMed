...
def eval(model, data_eval, voc_size, epoch):
    ...
    # ddi rate
    ddi_rate = ddi_rate_score(smm_record, path="../data/ready/MIMIC-III/ddi_A_final.pkl")
...
def main():
    ...
    molecule_path = "../data/ready/MIMIC-III/atc3toSMILES.pkl"
        ...
        for step, input in enumerate(data_train):
            ...
            for idx, adm in enumerate(input):
                ...
                current_ddi_rate = ddi_rate_score(
                    [[y_label]], path="../data/ready/MIMIC-III/ddi_A_final.pkl"
                )
